                        ...
                        <div className="col-lg-4">
                            <Animate className="animate__animated animate__fadeInUp" delay="100ms">
                                <div className="pricing-style-one">
                                    ...
                                    <Link className="btn btn-gradient btn-md animation" href="/contact-us">Purchase Plan</Link>
                                </div>
                            </Animate>
                        </div>
                                    ...
                                    <div className="row">
                                        <div className="col-lg-6">
                                            <div className="pricing-style-one">
                                                ...
                                                <Link className="btn btn-dark btn-md animation" href="/contact-us">Purchase Plan</Link>
                                            </div>
                                        </div>
                                        <div className="col-lg-6">
                                            <div className="pricing-style-one">
